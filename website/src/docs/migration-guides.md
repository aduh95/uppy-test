...
<script nomodule src="https://releases.transloadit.com/uppy/v2.2.4/uppy.legacy.min.js"></script>
<script type="module">import "https://releases.transloadit.com/uppy/v2.2.4/uppy.min.js";</script>
```
