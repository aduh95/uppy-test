...
```html
<link rel="stylesheet" href="https://releases.transloadit.com/uppy/v2.2.4/robodog.min.css">
<script src="https://releases.transloadit.com/uppy/v2.2.4/robodog.min.js"></script>
```
