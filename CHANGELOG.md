...
| @uppy/dropbox             |                     2.0.5 | @uppy/unsplash            |                     2.0.4 |
| @uppy/facebook            |                     2.0.5 | @uppy/url                 |                     2.0.5 |
| @uppy/file-input          |                     2.0.5 | @uppy/utils               |                     4.0.4 |
| @uppy/golden-retriever    |                     2.0.6 | @uppy/webcam              |                     2.0.5 |
| @uppy/google-drive        |                     2.0.5 | @uppy/xhr-upload          |                     2.0.6 |
| @uppy/image-editor        |                     1.0.5 | @uppy/zoom                |                     1.0.5 |
| @uppy/instagram           |                     2.0.5 | @uppy/robodog             |                     2.1.4 |
